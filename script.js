...
const CONFIG = {
  ...
  letter: {
    ...
    paragraphs: [
      'I don\u2019t know if words will ever be enough, but I wanted you to have something you can always come back to.',
      'Every laugh, every late-night talk, every ordinary moment beside you quietly became my favourite memory.',
      'You make the world softer just by being in it. You make me want to be gentler, braver, better.',
      'So here is my promise, written where you can keep it: however long it takes, however far we go \u2014 I will keep choosing you.',
    ],
